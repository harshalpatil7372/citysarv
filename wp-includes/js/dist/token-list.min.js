...
this.wp = this.wp || {}, this.wp.tokenList = function(e) {
    var t = {};
    ...
    hwXU: function(e, t, r) {
        ...
        class u {
            constructor() {
                ...
                this.value = e, this._currentValue, this._valueAsArray
            }
            entries() {
            ...
            set value(e) {
                e = String(e), this._valueAsArray = Object(n.uniq)(Object(n.compact)(e.split(/\s+/g))), this._currentValue = this._valueAsArray.join(" ")
            }
            get length() {
            ...
            remove() {
                for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                this.value = Object(n.without)(this._valueAsArray, ...t).join(" ")
            }
            toggle(e, t) {
