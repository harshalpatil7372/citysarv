    ...
    [882, 723, 209, 745, 120, 192, 520, 181, 791, 268, 357], {
            ...
            class baseTabs extends elementorModules.frontend.handlers.Base {
                ...
                activateTab(e) {
                    ...
                    i.add(n).addClass(s), i.attr({
                        ...
                        "aria-selected": "true",
                        "aria-expanded": "true"
                    }), n[t.showTabFn](o, (() => elementorFrontend.elements.$window.trigger("resize"))), n.removeAttr("hidden")
                }
                isActiveTab(e) {
        ...
        3896: (e, t, s) => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                initModal: function() {
                    const t = e.exports.modal = elementorFrontend.getDialogsManager().createWidget("lightbox", {
                ...
                setVideoContent: function(e) {
                    ...
                    if ("hosted" === e.videoType) {
                        ...
                        let s = elementorFrontend.utils.baseVideoLoader; - 1 !== e.url.indexOf("vimeo.com") ? s = elementorFrontend.utils.vimeo : e.url.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (s = elementorFrontend.utils.youtube), a = t("<iframe>", {
                ...
                getShareLinks: function() {
                    const {
                        ...
                        facebook: e.shareOnFacebook,
                        twitter: e.shareOnTwitter,
                        pinterest: e.pinIt
                    }, s = jQuery, i = this.getSettings("classes"), n = this.getSettings("selectors"), o = s("<div>", {
                        class: i.slideshow.shareLinks
                    }), a = this.getSlide("active"), r = a.find(n.image), l = a.data("elementor-slideshow-video");
                    let d;
                    return d = l || r.attr("src"), s.each(t, ((e, t) => {
                        const i = s("<a>", {
                            href: this.createShareLink(e, d),
                            target: "_blank"
                        }).text(t);
                        i.prepend(s("<i>", {
                            class: "eicon-" + e
                        ...
                        href: d,
                        download: ""
                    }).text(e.downloadImage).prepend(s("<i>", {
                ...
                createShareLink: function(e, t) {
                    ...
                    if ("pinterest" === e) s.image = encodeURIComponent(t);
                        ...
                        const e = elementorFrontend.utils.urlActions.createActionHash("lightbox", {
                            id: this.id,
                            url: t
                        });
                    ...
                    if (s || i || n || o) {
                        if (l.$header = t("<header>", {
                            ...
                            s.on("click", (e => {
                                ...
                                class: r.shareMenu
                            }).append(s), l.$iconShare.add(l.$shareMenu).on("click", this.toggleShareMenu), l.$header.append(l.$iconShare, l.$shareMenu), this.$buttons = this.$buttons.add(l.$iconShare)
                        }
                        return n && (l.$iconZoom = t("<i>", {
                            class: r.iconZoomIn,
                            role: "switch",
                            "aria-checked": !1,
                            "aria-label": e.zoom
                        ...
                        }).append(t("<span>"), t("<span>")), l.$iconExpand.on("click", this.toggleFullscreen), l.$header.append(l.$iconExpand), this.$buttons = this.$buttons.add(l.$iconExpand)), s && (l.$counter = t("<span>", {
                            class: r.counter
                ...
                setSlideshowContent: function(e) {
                    const {
                        i18n: t
                    } = elementorFrontend.config, s = jQuery, i = 1 === e.slides.length, n = "" !== elementorFrontend.getKitSettings("lightbox_title_src"), o = "" !== elementorFrontend.getKitSettings("lightbox_description_src"), a = n || o, r = this.getSettings("classes"), l = r.slideshow, d = s("<div>", {
                        class: l.container
                    }), c = s("<div>", {
                        class: l.slidesWrapper
                    });
                    let h, u;
                    e.slides.forEach((e => {
                        ...
                        c.append(n)
                    })), this.elements.$container = d, this.elements.$header = this.getSlideshowHeader(), d.prepend(this.elements.$header).append(c), i || (h = s("<div>", {
                        class: l.prevButton + " " + r.preventClose,
                        "aria-label": t.previous
                    }).html(s("<i>", {
                        class: l.prevButtonIcon
                    })), u = s("<div>", {
                        class: l.nextButton + " " + r.preventClose,
                        "aria-label": t.next
                    }).html(s("<i>", {
                        class: l.nextButtonIcon
                    })), d.append(u, h), this.$buttons = this.$buttons.add(u).add(h)), a && (this.elements.$footer = this.getSlideshowFooter(), d.append(this.elements.$footer)), this.setSettings("hideUiTimeout", ""), d.on("click mousemove keypress", this.showLightboxUi);
