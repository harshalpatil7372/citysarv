    ...
    var WprElements = {
        ...
        widgetAdvancedText: function($scope) {
            ...
            function hideWord($word) {
                ...
                if ($word.parents('.wpr-anim-text').hasClass('wpr-anim-text-type-typing')) {
                    ...
                    setTimeout(function() {
                        showWord(nextWord, animDuration)
                    }, typeAnimationDelay);
                    ...
                    $word.parents('.wpr-anim-text-inner').animate({
                        width: '2px'
            ...
            function showLetter($letter, $word, $bool, $duration) {
                ...
                if (!$letter.is(':last-child')) {
                    ...
                    if ($word.parents('.wpr-anim-text').hasClass('wpr-anim-text-type-typing')) {
                        setTimeout(function() {
                            $word.parents('.wpr-anim-text-inner').addClass('waiting');
                        }, 200);
                    }
                    if (!$bool) {
                        setTimeout(function() {
        ...
        widgetTabs: function($scope) {
            ...
            function wprTabsSwitcher(index) {
                ...
                $contentWrap.css({
                    'height': $contentWrap.outerHeight(true)
                });
